from model_patch_same_size import DRSN_CS          # 可用下一行替换，来判断有无shrinkage模块的区别
# from model_patch_same_size_without_shrinkage import  DRSN_CS      # 去掉SDERSN中的shrinkage模块
...
train_samples = 50        ###  训练对数等于 train_smaples * batch_size
valida_size = 100
batch_size = 5
# 定义优化方法
...
for epoch in range(epochs):
    ...
    print("epoch={}，训练loss：{:.4f}，验证loss：{:.4f}".format(epoch + 1, train_loss, val_loss))
